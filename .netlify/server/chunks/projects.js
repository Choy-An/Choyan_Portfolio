...
const items = [
  {
    slug: "Project 1",
    color: "#ffff00",
    description: "An exploration of how Sacred Groves (Kaavus) in Kannur have transformed into built structures. The project studies their architecture and iconography, presented through research, case studies, and visual documentation.",
    shortDescription: "An exploration of how Sacred Groves (Kaavus) in Kannur have transformed into built structures. The project studies their architecture and iconography, presented through research, case studies, and visual documentation.",
    ...
    name: "Sacred Groves",
    period: {
      from: new Date("2024-03-14"),
      to: new Date("2024-04-27")
    },
